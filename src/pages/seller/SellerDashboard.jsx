...
import { FaExchangeAlt, FaBoxOpen, FaUserAlt, FaTags, FaSeedling, FaSignOutAlt } from "react-icons/fa";
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "18px" }}>
            ...
            >
              ...
              <input
                type="text"
                placeholder="Retailer address or wallet"
                value={newOwner}
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            >
              ...
              >
                ...
                <option value="In Transit" style={{ background: "#2d2b3d" }}>
                  In Transit
                </option>

                <option value="Delivered" style={{ background: "#2d2b3d" }}>
                  Delivered
                </option>

                <option value="At Warehouse" style={{ background: "#2d2b3d" }}>
                  At Warehouse
                </option>

                <option value="At Retailer" style={{ background: "#2d2b3d" }}>
                  At Retailer
                </option>
          ...
          {message && (
            <p style={{ color: "#7ec850", fontSize: "13px", marginBottom: "16px" }}>
              {message}
            </p>
          )}
